...
export class EditIssueComponent implements OnInit {
  ...
  public updateIssue = () => {
    ...
    this.appService.editIssue(data,this.issueId).subscribe((apiResponse: any) => {
      this.getIssue();
      this.toastr.success("Issue edited succesfully");
      setTimeout(()=>{
          this.router.navigate(['/issueDetails',this.issueId]);
        },1000)
